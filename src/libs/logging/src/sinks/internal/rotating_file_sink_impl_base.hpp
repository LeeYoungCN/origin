#ifndef ORIGIN_LOGGING_SINKS_INTERNAL_ROTATING_FILE_SINK_IMPL_BASE_HPP
#define ORIGIN_LOGGING_SINKS_INTERNAL_ROTATING_FILE_SINK_IMPL_BASE_HPP
...
#endif  // ORIGIN_LOGGING_SINKS_INTERNAL_ROTATING_FILE_SINK_IMPL_BASE_HPP
