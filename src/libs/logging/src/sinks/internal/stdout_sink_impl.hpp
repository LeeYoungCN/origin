#pragma once
#ifndef ORIGIN_LOGGING_SINKS_INTERNAL_STDOUT_SINK_IMPL_HPP
#define ORIGIN_LOGGING_SINKS_INTERNAL_STDOUT_SINK_IMPL_HPP
...
#endif  // ORIGIN_LOGGING_SINKS_INTERNAL_STDOUT_SINK_IMPL_HPP
